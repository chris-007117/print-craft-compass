...
export const Footer = () => {
  ...
  const subscribe = async (e: React.FormEvent) => {
    ...
    if (error && !error.message.includes("duplicate")) {
      ...
      toast({ title: "Subscribed", description: "Welcome to Insights from Forma & Press." });
      setEmail("");
    }
  };
    ...
    <footer className="bg-charcoal text-bone/80">
        ...
        <div className="grid gap-12 lg:grid-cols-12">
          <div className="lg:col-span-4">
            ...
            <p className="mt-5 text-sm leading-relaxed max-w-sm">
              Premium commercial print and packaging for healthcare, technology, and consumer brands. Family-owned since 1987.
            </p>
          ...
          <div className="lg:col-span-4">
            ...
            <div className="grid sm:grid-cols-2 gap-6 text-sm">
              <div>
                <p className="text-copper font-medium uppercase text-xs tracking-wider mb-2">San Jose HQ</p>
                <p>2840 Industrial Way<br/>San Jose, CA 95131</p>
                <p className="mt-2"><a href="tel:+14085551987" className="hover:text-copper">408.555.1987</a></p>
                <p className="text-xs text-bone/60 mt-1">Mon–Fri 7a–7p PT</p>
              </div>
              <div>
                <p className="text-copper font-medium uppercase text-xs tracking-wider mb-2">Sacramento</p>
                <p>1112 North 16th St<br/>Sacramento, CA 95811</p>
                <p className="mt-2"><a href="tel:+19165551987" className="hover:text-copper">916.555.1987</a></p>
                <p className="text-xs text-bone/60 mt-1">Mon–Fri 7a–6p PT</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="border-t border-bone/10">
        <div className="container-x py-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 text-xs text-bone/50">
          <p>© {new Date().getFullYear()} Forma & Press, Inc. All rights reserved.</p>
          <div className="flex items-center gap-5">
            ...
            <Link to="/contact" className="hover:text-copper">Privacy</Link>
            <Link to="/contact" className="hover:text-copper">Accessibility</Link>
            <Link to="/contact" className="hover:text-copper">AI Usage</Link>
          </div>
        </div>
      </div>
    </footer>
